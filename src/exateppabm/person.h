 ...
 */
namespace states {
// default state for person agents
constexpr char DEFAULT[] = "default";
// State used for transmissionFile logging, to reduce host-to-device transfers and iteration. Temporarily contains newly-susceptible individuals.
constexpr char TRANSMISSION_FILE[] = "transmission_file";
